...
class SpeciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create species" do
    assert_difference('Species.count') do
      post species_index_url, params: { species: { average_height: @species.average_height, average_lifespan: @species.average_lifespan, classifiation: @species.classifiation, designation: @species.designation, eye_colors: @species.eye_colors, hair_colors: @species.hair_colors, language: @species.language, name: @species.name, skin_colors: @species.skin_colors } }
    end
  ...
  test "should update species" do
    patch species_url(@species), params: { species: { average_height: @species.average_height, average_lifespan: @species.average_lifespan, classifiation: @species.classifiation, designation: @species.designation, eye_colors: @species.eye_colors, hair_colors: @species.hair_colors, language: @species.language, name: @species.name, skin_colors: @species.skin_colors } }
