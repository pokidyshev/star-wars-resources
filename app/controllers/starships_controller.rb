class StarshipsController < ApplicationController
  ...
  private
    ...
    def starship_params
      params.require(:starship).permit(:MGLT, :cargo_capacity, :consumables, :cost_in_credits, :crew, :hyperdrive_rating, :length, :manufacturer, :max_atmosphering_speed, :model, :name, :passengers, :starship_class)
    end
end
